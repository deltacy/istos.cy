...
subtopic_data = {
  ...
  benefits: {
    'help-for-families': {
      el: { name: 'Οικονομική υποστήριξη οικογενειών' , description: 'Οικονομική βοήθεια για οικογένειες και άτομα που προσέχουν παιδιά' },
      en: { name: 'Financial support for families', description: 'Help if you are looking after children or plan to have or adopt a child' }
    }
  }
}
